...
type BadgeVariation = "base" | "super"

interface BadgeCheckIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
    size?: BadgeSize
...
const variationMap: Record<BadgeVariation, string> = {
    base: "#0b66ff",
    super: "#FFD700"
}
...
const BadgeCheckIcon: React.FC<BadgeCheckIconProps> = ({
    ...
    const fill = variationMap[variation]
