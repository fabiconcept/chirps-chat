  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "w-full bg-linear-to-b from-foreground/10 to-transparent rounded-3xl",
        className
      )}
      {...props}
    >
      ...
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          position === "popper" &&
            ...
            "w-full bg-linear-to-t from-foreground/10 to-transparent rounded-3xl p-1",
          className
        )}
        position={position}
        align={align}
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-accent cursor-pointer focus:text-accent-foreground [&_svg:not([class*='text-'])]:text-muted-foreground relative flex w-full items-center gap-2 rounded-2xl py-1.5 pr-8 pl-2 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
      {...props}
    >
